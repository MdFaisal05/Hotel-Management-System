...
public class AddDriver extends JFrame implements ActionListener{
    ...
    AddDriver() {
        ...
        lblroomno.setBounds(60, 70, 150, 20);
        add(lblroomno);
        
        tfname = new JTextField();
        tfname.setBounds (200, 70, 180, 30);
        add(tfname);
   ...
   gendercombo.setBackground(Color.WHITE);
       ...
       lbltype.setBounds(60, 230, 120, 30);
        ...
        tfmodel.setBounds (200, 230, 180, 30);
        add(tfmodel);
        
           JLabel lbltavailabel  = new JLabel("Available");
       lbltavailabel.setFont(new Font("Tahoma", Font.PLAIN, 18));
       lbltavailabel.setBounds(60, 270, 120, 30);
        add(lbltavailabel);
        
         
        String draiverOptions [] = { "Available", "Busy"};
        availablecombo = new JComboBox(draiverOptions);
    ...
    lbllocation.setBounds(60, 310, 120, 30);
        add(lbllocation );
         ...
         tflocation.setBounds (200, 310, 180, 30);
        add(  tflocation);
